...
state=_this.scrollResponderMixinGetInitialState(),_this.
...
_captureInnerRef=function(ref){
_this._innerRef=ref;
},_this.

_captureRef=function(ref){
_this._ref=ref;
},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(ScrollView,[{key:'getScrollResponder',value:function getScrollResponder(){return this;}},{key:'getInnerViewNode',value:function getInnerViewNode(){return this._innerRef;}},{key:'scrollTo',value:function scrollTo(opts){if(typeof opts==='number'){opts={y:opts,x:arguments[1]};}if(opts.animated){this.getScrollResponder().scrollResponderScrollTo(opts.x||0,opts.y||0);}else{this.getScrollResponder().scrollResponderScrollWithouthAnimationTo(opts.x||0,opts.y||0);}}},{key:'handleScroll',value:function handleScroll(e){if(!this._scrollViewDom)this._scrollViewDom=_reactDom2.default.findDOMNode(this._ref);e.nativeEvent=e.nativeEvent||{};e.nativeEvent.contentOffset={x:this._scrollViewDom.scrollLeft,y:this._scrollViewDom.scrollTop};this.props.onScroll&&this.props.onScroll(e);}},{key:'render',value:function render()
...
return(
_react2.default.createElement(_ReactView2.default,_extends({},props,{ref:this._captureRef}),
contentContainer));


}}]);return ScrollView;}(_react.Component);ScrollView.defaultProps={scrollEnabled:true};
;
