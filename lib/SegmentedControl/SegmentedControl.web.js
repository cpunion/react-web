...
}}]);return SegmentedControl;}(_react.Component);SegmentedControl.propTypes={values:_propTypes2.default.arrayOf(_propTypes2.default.string),selectedIndex:_propTypes2.default.number,onValueChange:_propTypes2.default.func,onChange:_propTypes2.default.func,enabled:_propTypes2.default.bool,tintColor:_propTypes2.default.string,momentary:_propTypes2.default.bool};SegmentedControl.defaultProps={values:[],enabled:true};
;
