...
_captureTotalTrackRef=function(ref){
_this._totalTrackRef=ref;
};_this.
_captureMinTrackRef=function(ref){
_this._minTrackRef=ref;
};_this.
_captureThumbRef=function(ref){
_this._thumbRef=ref;
};_this.state={value:props.value};return _this;}_createClass(Slider,[{key:'componentWillMount',value:function componentWillMount(){this._panResponder=_ReactPanResponder2.default.create({onStartShouldSetPanResponder:this._handleStartShouldSetPanResponder.bind(this),onMoveShouldSetPanResponder:this._handleMoveShouldSetPanResponder.bind(this),onPanResponderGrant:this._handlePanResponderGrant.bind(this),onPanResponderMove:this._handlePanResponderMove.bind(this),onPanResponderRelease:this._handlePanResponderEnd.bind(this),onPanResponderTerminate:this._handlePanResponderEnd.bind(this)});}},{key:'render',value:function render()
...
_react2.default.createElement(_ReactView2.default,{ref:this._captureTotalTrackRef,
style:[
{backgroundColor:maximumTrackTintColor},
mainStyles.track,trackStyle,
disabled&&{backgroundColor:mainStyles.disabled.backgroundColor}]}),

_react2.default.createElement(_ReactView2.default,{ref:this._captureMinTrackRef,style:[mainStyles.track,trackStyle,minimumTrackStyle]}),

thumbImage&&thumbImage.uri&&
_react2.default.createElement(_ReactImage2.default,_extends({ref:this._captureThumbRef,source:thumbImage,style:[
...
_react2.default.createElement(_ReactView2.default,_extends({ref:this._captureThumbRef,style:[
...
var totalWidth=this._getWidth(this._totalTrackRef);
...
trackImage:_propTypes2.default.any,



thumbImage:_propTypes2.default.any,
