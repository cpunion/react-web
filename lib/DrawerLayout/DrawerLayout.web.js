...
this.props,drawerPosition=_props.drawerPosition,drawerWidth=_props.drawerWidth;
...
e,_ref3){var moveX=_ref3.moveX,dx=_ref3.dx,dy=_ref3.dy;var
...
e,_ref5){var moveX=_ref5.moveX,vx=_ref5.vx;var
drawerPosition=this.props.drawerPosition;
...
}}]);return DrawerLayout;}(_react.Component);DrawerLayout.positions={Left:'left',Right:'right'};DrawerLayout.defaultProps={drawerWidth:0,drawerPosition:'left'};DrawerLayout.propTypes={drawerWidth:_propTypes2.default.number.isRequired,drawerPosition:_propTypes2.default.oneOf(['left','right']).isRequired,renderNavigationView:_propTypes2.default.func.isRequired,onDrawerSlide:_propTypes2.default.func,onDrawerStateChanged:_propTypes2.default.func,onDrawerOpen:_propTypes2.default.func,onDrawerClose:_propTypes2.default.func,keyboardDismissMode:_propTypes2.default.oneOf(['none','on-drag'])};
