...
var _setValueForStyles=require('../Utilties/setValueForStyles.web');var _setValueForStyles2=_interopRequireDefault(_setValueForStyles);
...
var _ReactScrollView=require('../ScrollView/ScrollView.web');var _ReactScrollView2=_interopRequireDefault(_ReactScrollView);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
...
(0,_setValueForStyles2.default)(instance,mapStyle(props.style));
}else{
return false;
}
}
...
ScrollView:_animated2.default.createAnimatedComponent(_ReactScrollView2.default),
