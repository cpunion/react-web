...
TabBarItem=function(_Component){_inherits(TabBarItem,_Component);function TabBarItem(){_classCallCheck(this,TabBarItem);return _possibleConstructorReturn(this,(TabBarItem.__proto__||Object.getPrototypeOf(TabBarItem)).apply(this,arguments));}_createClass(TabBarItem,[{key:'_onClick',value:function _onClick()
...
}}]);return TabBarItem;}(_react.Component);TabBarItem.propTypes={badge:_propTypes2.default.oneOfType([_propTypes2.default.string,_propTypes2.default.number]),icon:_propTypes2.default.object,selectedIcon:_propTypes2.default.string,onPress:_propTypes2.default.func,selected:_propTypes2.default.bool,style:_propTypes2.default.object,title:_propTypes2.default.string,selectedColor:_propTypes2.default.string};
...
(0,_autobindDecorator2.default)(TabBarItem);exports.default=
