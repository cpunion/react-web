...
pageCount:_this.props.children.length||1,
offsetLeft:new _ReactAnimated2.default.Value(0)},_this.
...
_this._ref=ref;
},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(ViewPager,[{key:'getInnerViewNode',value:function getInnerViewNode(){return this._ref.childNodes[0];}},{key:'componentWillMount',value:function componentWillMount(){this._panResponder=this.props.scrollEnabled&&_ReactPanResponder2.default.create({onStartShouldSetResponder:function onStartShouldSetResponder(){return true;},onMoveShouldSetPanResponder:this._shouldSetPanResponder,onPanResponderGrant:function onPanResponderGrant(){},onPanResponderMove:this._panResponderMove,onPanResponderTerminationRequest:function onPanResponderTerminationRequest(){return true;},onPanResponderRelease:this._panResponderRelease,onPanResponderTerminate:function onPanResponderTerminate(){}});}},{key:'componentDidMount',value:function componentDidMount(){this.setPage(this.state.selectedPage);}},{key:'_childrenWithOverridenStyle',value:function _childrenWithOverridenStyle(){return _react2.default.Children.map(this.props.children,function(child){var style=(0,_objectAssign2.default)({},child.props.style,{width:_ReactDimensions2.default.get('window').width});var newProps={style:style,collapsable:false};return(0,_react.cloneElement)(child,(0,_objectAssign2.default)({},child.props,newProps));});}},{key:'render',value:function render()

{
var children=this._childrenWithOverridenStyle();var _state=

this.state,offsetLeft=_state.offsetLeft,pageCount=_state.pageCount;
var pageWidth=_ReactDimensions2.default.get('window').width;
...
return _react2.default.createElement(_ReactView2.default,_extends({ref:this._captureRef,
...
var val=this.state.selectedPage+dx/_ReactDimensions2.default.get('window').width*-1;
this.state.offsetLeft.setValue(val);
}},{key:'_panResponderRelease',value:function _panResponderRelease(

ev,_ref3){var dx=_ref3.dx;var
selectedPage=this.state.selectedPage;
var range=Math.abs(dx)/_ReactDimensions2.default.get('window').width;
var threshold=1/5;
...
}}]);return ViewPager;}(_react2.default.Component);ViewPager.propTypes={initialPage:_propTypes2.default.number,onPageScroll:_propTypes2.default.func,onPageSelected:_propTypes2.default.func,keyboardDismissMode:_propTypes2.default.oneOf(['none','on-drag']),scrollEnabled:_propTypes2.default.bool};ViewPager.defaultProps={initialPage:0,scrollEnabled:true};
