...
return rendered;
}}]);return NavigatorNavigationBar;}(_react.Component);NavigatorNavigationBar.propTypes={navigator:_propTypes2.default.object,routeMapper:_propTypes2.default.shape({Title:_propTypes2.default.func.isRequired,LeftButton:_propTypes2.default.func.isRequired,RightButton:_propTypes2.default.func.isRequired}).isRequired,navState:_propTypes2.default.shape({routeStack:_propTypes2.default.arrayOf(_propTypes2.default.object),presentedIndex:_propTypes2.default.number}),navigationStyles:_propTypes2.default.object,style:_ReactView2.default.propTypes.style};NavigatorNavigationBar.statics={Styles:NavigatorNavigationBarStyles,StylesAndroid:_ReactNavigatorNavigationBarStylesAndroid2.default,StylesIOS:_ReactNavigatorNavigationBarStylesIOS2.default};NavigatorNavigationBar.defaultProps={navigationStyles:NavigatorNavigationBarStyles};
